      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="py-12 border-b">
          <div className="grid gap-8 md:grid-cols-2 items-center">
            <div className="space-y-2">
              <h3 className="text-2xl font-bold">Dapatkan Info Terbaru</h3>
              <p className="text-muted-foreground">
                Berlangganan newsletter kami untuk mendapatkan informasi mobil
                terbaru, promo menarik, dan tips membeli mobil bekas.
              </p>
            </div>
        ...
        <div className="py-12 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Platform terpercaya untuk jual beli mobil bekas berkualitas. Kami
              menyediakan layanan terbaik dengan harga yang kompetitif.
            </p>
            <div className="space-y-2">
        ...
        <div className="py-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-sm text-muted-foreground">
            © {currentYear} MobilBekas. Semua hak dilindungi undang-undang.
          </div>
