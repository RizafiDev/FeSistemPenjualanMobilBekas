    ...
    >
      <div className="relative overflow-hidden">
        <div className="aspect-[4/3] relative">
          <Image
            src={stockCar.foto_url || "/images/car-placeholder.jpg"} // ✅ Use foto_url from stock
            alt={car.nama}
            fill
        ...
        <div className="absolute top-3 left-3">
          <Badge
            variant={stockCar.status === "tersedia" ? "default" : "secondary"}
          >
        ...
        <div className="absolute top-3 right-3">
          <Badge variant={stockCar.kondisi === "baru" ? "default" : "outline"}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="capitalize">{stockCar.warna}</span>
              </div>
            </div>
          ...
          <div className="flex items-center gap-4 text-sm text-muted-foreground">
            {stockCar.kilometer && (
              <div className="flex items-center gap-1">
                ...
                <span>{stockCar.kilometer.toLocaleString()} km</span>
              </div>
            )}
          </div>
