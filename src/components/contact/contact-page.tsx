            ...
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 mb-6">
                  Terima kasih telah menghubungi kami. Tim customer service kami
                  akan merespons pesan Anda dalam waktu 1x24 jam.
                </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Butuh bantuan atau informasi lebih lanjut? Jangan ragu untuk
              menghubungi kami. Tim kami siap membantu Anda menemukan mobil
              bekas yang tepat.
            </p>
          </div>
                ...
                <CardContent>
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="nama" className="pb-3">
                          Nama Lengkap *
                        </Label>
                        <Input
                          id="nama"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="telepon" className="pb-3">
                          Nomor Telepon *
                        </Label>
                        <Input
                          id="telepon"
                      ...
                      <div>
                        <Label htmlFor="subjek" className="pb-3">
                          Subjek *
                        </Label>
                        <Input
                          id="subjek"
                ...
                <CardContent>
                  <div className="bg-gray-100 h-64 rounded-lg flex items-center justify-center">
                    <div className="text-center text-gray-500">
                      ...
                      <p>Peta Lokasi</p>
                      <p className="text-sm">
                        Integrasi Google Maps akan tersedia segera
                      </p>
                    </div>
                  </div>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium">Alamat Showroom</h4>
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <Badge variant="outline">08:00 - 15:00</Badge>
                    </div>
                    <div className="flex justify-between items-center">
              ...
              <Card>
                <CardContent className="p-4">
                  <h4 className="font-medium mb-2">Pertanyaan Umum</h4>
                  <p className="text-sm text-gray-600 mb-3">
                    Cek FAQ kami untuk jawaban cepat atas pertanyaan yang sering
                    diajukan.
                  </p>
