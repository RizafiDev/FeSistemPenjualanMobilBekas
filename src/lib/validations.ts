...
export const appointmentFormSchema = z
  .object({
    ...
    tujuan: z.string().max(1000, "Tujuan maksimal 1000 karakter").optional(),
    pesan_tambahan: z
      .string()
